  ...
  <div class="d-flex">
      <div id="sidbar-container" class=" btn-pramiry">
          <div class="logo ">
            ...
            <div class="menu">
                <a href="#" class="d-block  text-light p-3 " ><i class="icon ion-md-apps"></i>dashboard</a>
                <a href="# " class="d-block  text-light p-3"><i class="icon ion-md-people"></i>rhgkn</a>
                <a href="#" class="d-block text-light p-3"><i class="icon ion-ios-stats"></i>vnrnh</a>
            </div>
      </div>
      <div class="w-100">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown">
         ...
         <img src="images/icon-delivery.png" alt="" class="img-fluid rounded-circle img mr-2"> Dropdown
         </a>
